/**
 * Fixed WhatsApp button — opens chat with a friendly pre-filled message.
 * Edit WHATSAPP_MESSAGE below to change the default text.
 */
(function () {
  "use strict";

  var WHATSAPP_DIGITS = "919393055583";
  ...
  a.setAttribute(
    "aria-label",
    "Chat on WhatsApp — we are here to help"
  );
  a.title = "Message us on WhatsApp";
  a.className = [
    "fixed bottom-5 right-5 z-[60]",
    "flex h-14 w-14 items-center justify-center",
    "rounded-full bg-[#25D366] text-white shadow-lg shadow-emerald-900/30",
